...
4. Check for established workflows:
   - Read OPENCODE.md (if exists) to understand project-specific workflows and rules
   ...
   - Check OPENCODE.md for explicit workflow requirements for this type of work
