...
3.  **Draft `spec.md`:** Once sufficient information is gathered, draft the most detailed (verbose) and descriptive content for the track's `spec.md` file, including sections like Overview, Functional Requirements, Non-Functional Requirements (if any), Acceptance Criteria, and Out of Scope.
...
2.  **Generate Plan:**
    ...
    *   **CRITICAL:** The plan generation must be most detailed (verbose) and descriptive. The plan structure MUST adhere to the methodology in the **Workflow** file (e.g., TDD tasks for "Write Tests" and "Implement").
