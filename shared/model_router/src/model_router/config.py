...
# assembled from environment variables for both AURA applications and tests.

# @see: model_router/router.py - Runtime auto-registration logic
# @note: Vertex config falls back to GOOGLE_CLOUD_* vars used elsewhere.
...
class VertexAIConfig(BaseModel):
    ...
    def from_env(cls) -> "VertexAIConfig":
        ...
        return cls(
            project_id=(
                os.getenv("VERTEX_PROJECT") or os.getenv("GOOGLE_CLOUD_PROJECT") or ""
            ),
            region=(
